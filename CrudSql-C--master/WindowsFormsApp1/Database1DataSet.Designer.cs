...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsuariosRow AddUsuariosRow(int UserID, string Login, string Senha) {
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([UserID] = @Original_UserID) AND ([Login] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([UserID], [Login], [Senha]) VALUES (@UserID, @Login" +
                ", @Senha);\r\nSELECT UserID, Login, Senha FROM Usuarios WHERE (UserID = @UserID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [UserID] = @UserID, [Login] = @Login, [Senha] = @Senh" +
                "a WHERE (([UserID] = @Original_UserID) AND ([Login] = @Original_Login) AND ([Sen" +
                "ha] = @Original_Senha));\r\nSELECT UserID, Login, Senha FROM Usuarios WHERE (UserI" +
                "D = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Login, Senha FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_UserID, string Original_Login, string Original_Senha) {
        ...
        public virtual int Insert(int UserID, string Login, string Senha) {
        ...
        public virtual int Update(int UserID, string Login, string Senha, int Original_UserID, string Original_Login, string Original_Senha) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Login, string Senha, int Original_UserID, string Original_Login, string Original_Senha) {
            return this.Update(Original_UserID, Login, Senha, Original_UserID, Original_Login, Original_Senha);
        }
    }
